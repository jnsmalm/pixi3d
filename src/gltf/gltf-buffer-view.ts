...
export class glTFBufferView {
  constructor(public buffer: Uint32Array | Float32Array | Int8Array | Uint8Array | Int16Array | Uint16Array, public componentType: number, public stride = 0) {
  }
  ...
  static from(componentType: number, buffer: ArrayBuffer, offset: number, size: number, stride?: number) {
    switch (componentType) {
      ...
      case 5120: return new glTFBufferView(
        new Int8Array(buffer, offset, size), componentType, stride)
